...
# logFile = "{0}/triventLog_{1}Shiiiit" # % (logPath, runNumber)
...
# inputFile = "{0}/DHCAL_{1}_SO_Antoine.slcio" # % (intputPath,runNumber) Is parsed by trivent.py to build the xmlFile
inputFile = "{0}/DHCAL_{1}_I0_0.slcio" # % (intputPath,runNumber) Is parsed by trivent.py to build the xmlFile
#outputFile = "{0}/TDHCAL_Antoine_{1}POS" # extension slcio/root added in xml # % (outputPath,runNumber)
outputFile = "{0}/TDHCAL_Laurent_{1}" # extension slcio/root added in xml # % (outputPath,runNumber)
# outputFile = "{0}/TDHCAL_{1}_SHIIIITCErenkov" # extension slcio/root added in xml # % (outputPath,runNumber)
