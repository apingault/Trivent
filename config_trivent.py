...
# inputFile = "{0}/DHCAL_{1}_SO.slcio" # % (intputPath,runNumber) Is parsed by trivent.py to build the xmlFile
outputFile = "{0}/TDHCAL_Antoine_{1}POS" # extension slcio/root added in xml # % (outputPath,runNumber)
# outputFile = "{0}/TDHCAL_Antoine_{1}" # extension slcio/root added in xml # % (outputPath,runNumber)
